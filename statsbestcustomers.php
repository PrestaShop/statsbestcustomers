...
class statsbestcustomers extends ModuleGrid
{
    ...
    public function __construct()
    {
        ...
        $this->description = $this->trans('Enrich the ‘Stats’ section of your back office, add a list of the best customers to the dashboard.', array(), 'Modules.Statsbestcustomers.Admin');
